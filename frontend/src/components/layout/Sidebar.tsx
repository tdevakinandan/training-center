...
const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    hasSubmenu: true,
    submenu: [
      { title: "Basic Tables", href: "/tables" },
      { title: "Data Tables", href: "/tables/data" },
    ]
  },
  { title: "Leads", href: "/leads", icon: Users },
  { title: "Employee", href: "/employee", icon: Users }, // <- Added Employee
                  ...
                  {item.hasSubmenu ? (
                    <Button
                      ...
                      className={cn(
                        ...
                        (isActive || hasActiveSubmenu) && "bg-dashboard-sidebar-active text-white"
                      )}
                ...
                {item.hasSubmenu && isExpanded && (
                  <div className="ml-4 mt-2 space-y-1">
                    {item.submenu?.map((subItem) => {
                      ...
                      return (
                        <Link key={subItem.href} to={subItem.href} onClick={onToggle}>
                          <Button
                            variant="ghost"
                            size="sm"
                            className={cn(
                              ...
                              isSubActive && "bg-dashboard-sidebar-active text-white"
                            )}
                          >
